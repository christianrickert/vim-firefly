...
hi PreProc guifg=#f9e173 guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if get(g:, 'dark_transp_bg', 0)
    ...
    hi Terminal ctermfg=249 ctermbg=235 cterm=NONE
  endif
  hi ColorColumn ctermfg=fg ctermbg=235 cterm=NONE
  hi Conceal ctermfg=NONE ctermbg=NONE cterm=NONE
  hi Cursor ctermfg=249 ctermbg=235 cterm=reverse
  hi CursorColumn ctermfg=249 ctermbg=235 cterm=NONE
  hi CursorLine ctermfg=249 ctermbg=235 cterm=NONE
  hi CursorLineNr ctermfg=249 ctermbg=235 cterm=NONE
  hi DiffAdd ctermfg=249 ctermbg=235 cterm=reverse
  hi DiffChange ctermfg=249 ctermbg=235 cterm=reverse
  hi DiffDelete ctermfg=249 ctermbg=235 cterm=reverse
  hi DiffText ctermfg=249 ctermbg=235 cterm=bold,reverse
  hi Directory ctermfg=249 ctermbg=235 cterm=NONE
  hi EndOfBuffer ctermfg=249 ctermbg=235 cterm=NONE
  hi ErrorMsg ctermfg=249 ctermbg=235 cterm=reverse
  hi FoldColumn ctermfg=249 ctermbg=235 cterm=NONE
  hi Folded ctermfg=249 ctermbg=235 cterm=italic
  hi IncSearch ctermfg=249 ctermbg=235 cterm=reverse
  hi LineNr ctermfg=241 ctermbg=235 cterm=NONE
  hi MatchParen ctermfg=249 ctermbg=235 cterm=reverse
  hi ModeMsg ctermfg=249 ctermbg=235 cterm=NONE
  hi MoreMsg ctermfg=249 ctermbg=235 cterm=NONE
  hi NonText ctermfg=249 ctermbg=235 cterm=NONE
  hi Pmenu ctermfg=249 ctermbg=235 cterm=NONE
  hi PmenuSbar ctermfg=249 ctermbg=235 cterm=NONE
  hi PmenuSel ctermfg=249 ctermbg=235 cterm=reverse
  hi PmenuThumb ctermfg=249 ctermbg=235 cterm=NONE
  hi Question ctermfg=249 ctermbg=235 cterm=NONE
  hi Search ctermfg=249 ctermbg=235 cterm=reverse
  hi SignColumn ctermfg=249 ctermbg=235 cterm=NONE
  hi SpecialKey ctermfg=249 ctermbg=235 cterm=NONE
  hi SpellBad ctermfg=249 ctermbg=235 cterm=NONE
  hi SpellCap ctermfg=249 ctermbg=235 cterm=NONE
  hi SpellLocal ctermfg=249 ctermbg=235 cterm=NONE
  hi SpellRare ctermfg=249 ctermbg=235 cterm=reverse
  ...
  hi TabLineFill ctermfg=249 ctermbg=235 cterm=NONE
  hi TabLineSel ctermfg=249 ctermbg=235 cterm=NONE
  hi Title ctermfg=249 ctermbg=235 cterm=NONE
  hi VertSplit ctermfg=249 ctermbg=235 cterm=NONE
  hi Visual ctermfg=249 ctermbg=235 cterm=reverse
  hi VisualNOS ctermfg=249 ctermbg=235 cterm=NONE
  hi WarningMsg ctermfg=249 ctermbg=235 cterm=NONE
  hi WildMenu ctermfg=249 ctermbg=235 cterm=NONE
  hi Comment ctermfg=219 ctermbg=NONE cterm=italic
  hi Constant ctermfg=75 ctermbg=NONE cterm=NONE
  hi Error ctermfg=249 ctermbg=235 cterm=reverse
...
if s:t_Co >= 8
  ...
  hi MatchParen ctermfg=White ctermbg=Black cterm=reverse
...
" Color: light_red     #ff8c7e                  210        Red
" Color: vivid_orange  #faae3d                  214        Yellow
" Color: vivid_yellow  #f9e173                  227        Yellow
